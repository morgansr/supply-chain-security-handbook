...
![Relationship between the 5 critical controls. Note that the controls should be read in order from top to bottom and left to right.](/images/040_5_ics_critical_controls.png#center)
...
![alt text](/images/040_Major_Enforcement_Boundary.png)  
...
![alt text](/images/040_Minor_Enforcement_Boundary.png)  
